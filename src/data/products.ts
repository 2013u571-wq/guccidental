...
export const chairModels: ChairModel[] = [
  ...
  { model: "SL8500 Standard A", chairTier: "high-end", series: "SL8500 Series", summary: "Refined upholstery, integrated controls, and the complete Standard A layout support polished everyday treatment.", thumb: { src: mediaUrl("/images/products/dental-chair/sl8500.avif"), alt: "SL8500 high-end dental chair with brown upholstery and integrated delivery unit" } },
  { model: "SL8500 Standard B", chairTier: "high-end", series: "SL8500 Series", summary: "The Standard B configuration combines refined patient comfort with integrated controls for a clean clinical workflow.", thumb: { src: mediaUrl("/images/products/dental-chair/sl8500.avif"), alt: "SL8500 high-end dental chair with brown upholstery and integrated delivery unit" } },
  { model: "SL8500 without box A", chairTier: "high-end", series: "SL8500 Series", summary: "A box-free A layout opens the chairside area for flexible room planning and easier operator access.", thumb: { src: mediaUrl("/images/products/dental-chair/sl8500.avif"), alt: "SL8500 high-end dental chair with brown upholstery and integrated delivery unit" } },
  { model: "SL8500 without box B", chairTier: "high-end", series: "SL8500 Series", summary: "A box-free B layout keeps the treatment zone visually open while retaining the SL8500's premium comfort.", thumb: { src: mediaUrl("/images/products/dental-chair/sl8500.avif"), alt: "SL8500 high-end dental chair with brown upholstery and integrated delivery unit" } },
  { model: "SL8500 B", chairTier: "high-end", series: "SL8500 Series", summary: "A streamlined B configuration pairs refined upholstery with integrated chairside controls for premium general dentistry.", thumb: { src: mediaUrl("/images/products/dental-chair/sl8500.avif"), alt: "SL8500 high-end dental chair with brown upholstery and integrated delivery unit" } },
