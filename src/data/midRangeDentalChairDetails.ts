...
const sSeriesManualSlugs = new Set(["s610", "s620", "s630", "s640", "s650", "s660", "s690"]);
...
function buildDetail(slug: string, copy: DetailCopy): HighEndDentalChairDetail {
  ...
  return {
    ...
    resources: [
      ...
      ...(sSeriesManualSlugs.has(slug) ? [{
        label: "S Series Dental Chair Installation Manual",
        href: mediaUrl("/downloads/dental-chair/s610/guccidental-s-series-dental-chair-installation-manual.pdf"),
        meta: "PDF · 1.4 MB",
      }] : []),
    ],
...
export const midRangeDentalChairDetails: Record<string, HighEndDentalChairDetail> = {
  p2: buildDetail("p2", {
    ...
    videoPlaceholder: { title: "See the P2 in action", note: "Product videos are available in the supplied source package.", url: "https://youtube.com/shorts/ioH-wence9U", thumbnailUrl: "https://i.ytimg.com/vi/ioH-wence9U/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  p3: buildDetail("p3", {
    ...
    videoPlaceholder: { title: "See the P3 in action", note: "Product videos are available in the supplied source package.", url: "https://youtube.com/shorts/WcDASnqfF9E", thumbnailUrl: "https://i.ytimg.com/vi/WcDASnqfF9E/hqdefault.jpg" },
  ...
  p6: buildDetail("p6", {
    ...
    videoPlaceholder: { title: "See the P6 in action", note: "A product video is available in the supplied source package.", url: "https://youtu.be/Rgh7dQjFBfI", thumbnailUrl: "https://i.ytimg.com/vi/Rgh7dQjFBfI/hqdefault.jpg" },
    featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  g3: buildDetail("g3", {
    ...
    videoPlaceholder: { title: "See the G3 in action", note: "Product videos are available in the supplied source package.", url: "https://youtube.com/shorts/9nLzt7cXBpk", thumbnailUrl: "https://i.ytimg.com/vi/9nLzt7cXBpk/hqdefault.jpg" },
    featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  g7: buildDetail("g7", {
    ...
    videoPlaceholder: { title: "See the G7 in action", note: "Product videos are available in the supplied source package.", url: "https://youtube.com/shorts/uDf_hWM6ch0", thumbnailUrl: "https://i.ytimg.com/vi/uDf_hWM6ch0/hqdefault.jpg" },
    featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  s610: buildDetail("s610", {
    ...
    videoPlaceholder: { title: "See the S610 in action", note: "Product and shooting videos are available in the supplied source package.", url: "https://youtube.com/shorts/mmups0ve_0w", thumbnailUrl: "https://i.ytimg.com/vi/mmups0ve_0w/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
      {
  ...
  s620: buildDetail("s620", {
    ...
    videoPlaceholder: { title: "See the S620 in action", note: "Product and shooting videos are available in the supplied source package.", url: "https://youtube.com/shorts/NKH4UjgkqaA", thumbnailUrl: "https://i.ytimg.com/vi/NKH4UjgkqaA/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
      {
        eyebrow: "01 · Luxury LED operating light",
  ...
  s630: buildDetail("s630", {
    ...
    videoPlaceholder: { title: "See the S630 in action", note: "Product and upper-delivery videos are available in the supplied source package.", url: "https://youtube.com/shorts/Yt8G-XsIxOE", thumbnailUrl: "https://i.ytimg.com/vi/Yt8G-XsIxOE/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  s640: buildDetail("s640", {
    ...
    videoPlaceholder: { title: "Review the S640 configuration", note: "Brochure and installation resources are available below.", url: "https://youtube.com/shorts/tKlgijkfRXA", thumbnailUrl: "https://i.ytimg.com/vi/tKlgijkfRXA/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  s650: buildDetail("s650", {
    ...
    videoPlaceholder: { title: "See the S650 in action", note: "Product and operation videos are available in the supplied source package.", url: "https://youtu.be/4tVdJn9Exsk", thumbnailUrl: "https://i.ytimg.com/vi/4tVdJn9Exsk/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  s660: buildDetail("s660", {
    ...
    videoPlaceholder: { title: "See the S660 in action", note: "A product video is available in the supplied source package.", url: "https://youtube.com/shorts/W2jCEJeR0Uk", thumbnailUrl: "https://i.ytimg.com/vi/W2jCEJeR0Uk/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  s690: buildDetail("s690", {
    ...
    videoPlaceholder: { title: "See the S690 in action", note: "Product and presentation videos are available in the supplied source package.", url: "https://youtube.com/shorts/gTLNJv1OxFw", thumbnailUrl: "https://i.ytimg.com/vi/gTLNJv1OxFw/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  "ql-2028iv": buildDetail("ql-2028iv", {
    ...
    videoPlaceholder: { title: "See the QL-2028IV in action", note: "A 45-second product introduction video is available in the supplied source package.", url: "https://youtu.be/xq9KdUv3fME", thumbnailUrl: "https://i.ytimg.com/vi/xq9KdUv3fME/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
      {
  ...
  "tj2028i-elite": buildDetail("tj2028i-elite", {
    ...
    videoPlaceholder: { title: "See the TJ2028I Elite in action", note: "A product video is available in the supplied source package.", url: "https://youtu.be/Hg4dNcfj3aQ", thumbnailUrl: "https://i.ytimg.com/vi/Hg4dNcfj3aQ/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  "tj2028ii-prime": buildDetail("tj2028ii-prime", {
    ...
    videoPlaceholder: { title: "See the TJ2028II Prime in action", note: "Product videos are available in the supplied source package.", url: "https://youtu.be/cfBdDe6TQxI", thumbnailUrl: "https://i.ytimg.com/vi/cfBdDe6TQxI/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
  ...
  "v2-pro": buildDetail("v2-pro", {
    ...
    videoPlaceholder: { title: "See the V2 Pro in action", note: "A product video is available in the supplied source package.", url: "https://youtu.be/UtynnqAEvu4", thumbnailUrl: "https://i.ytimg.com/vi/UtynnqAEvu4/hqdefault.jpg" }, featureHeading: "Built around the daily rhythm of a busy clinic",
    featureCopy: [
