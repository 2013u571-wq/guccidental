...
const sourceBase = "/Users/gaosong/Downloads/High-end - 副本 2/B100L Premium";
const outputDir = path.resolve("public/images/products/dental-chair/b100l-premium");

const heroDir = `${sourceBase}/01_首屏整屏信息与素材/01_左侧产品图库图片_复制件`;
const featureDir = `${sourceBase}/03_功能细节信息与素材`;
const colorDir = `${sourceBase}/04_皮革颜色信息与素材/B100L Premium_色卡资料`;
...
const gallery = [
  ["b100l-premium-gallery-01.webp", "03_1_副本.png", 2400],
  ["b100l-premium-gallery-02.webp", "04_3_副本.png", 2400],
  ["b100l-premium-gallery-03.webp", "05_2_副本.png", 2400],
  ["b100l-premium-gallery-04.webp", "06_7_副本.png", 2400],
  ["b100l-premium-gallery-05.webp", "21_副本.png", 2400],
  ["b100l-premium-gallery-06.webp", "4-2_副本.png", 2400],
];

const features = [
  ["b100l-premium-american-style-chair-body.webp", "01_American-Style Chair Body.png", 1800],
  ["b100l-premium-fixed-treatment-layout.webp", "02_Left Right Workflow Flexibility.png", 1800],
  ["b100l-premium-chairside-delivery-area.webp", "03_Chairside Delivery Area.png", 1800],
  ["b100l-premium-silicone-leather-upholstery.webp", "04_Silicone Leather Upholstery.png", 1800],
];

const cases = [
  ["b100l-premium-clinic-case-01.webp", "01_微信图片_20260722180138_18_67.png", 1400],
  ["b100l-premium-clinic-case-02.webp", "04_微信图片_20260722180136_17_67.png", 1400],
  ["b100l-premium-clinic-case-03.webp", "ChatGPT Image 2026年8月7日 10_35_50.png", 1400],
  ["b100l-premium-clinic-case-04.webp", "ChatGPT Image 2026年8月7日 10_37_26.png", null],
];
...
for (const [slug, file, swatchFile] of colors) {
  await convert(path.join(colorDir, file), path.join(outputDir, "colors", `b100l-premium-${slug}.webp`), 1800);
  await convert(path.join(swatchDir, swatchFile), path.join(outputDir, "colors/swatches", `b100l-premium-${slug}-swatch.webp`), 500, 92);
}
